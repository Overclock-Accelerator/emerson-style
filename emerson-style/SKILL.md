...
- Semicolons rare; commas carry the long sentences. A semicolon never joins two long clauses — split them so a subvocalizing reader gets the full stop to breathe (v1.9.0, Ahmed). Percentages and survey figures embedded mid-sentence, always attributed ("Of the 300 senior executives in our May 2025 survey, 88% say…").
